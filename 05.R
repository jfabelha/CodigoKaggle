...
install.packages("ROCR", lib="/Users/Jo?o/Downloads/Teste")
library(ROCR, lib="/Users/Jo?o/Downloads/Teste")
library("ipred", lib="/Users/Jo?o/Downloads/Teste")
install.packages("ipred", lib="/Users/Jo?o/Downloads/Teste")
library(e1071, lib="/Users/Jo?o/Downloads/Teste")
install.packages("randomForest", lib="/Users/Jo?o/Downloads/Teste")
library(randomForest, , lib="/Users/Jo?o/Downloads/Teste")
install.packages("plyr", lib="/Users/Jo?o/Downloads/Teste")
library("plyr", lib="/Users/Jo?o/Downloads/Teste")

arv2<-rpart(as.factor(amostraf$TARGET)~., amostraf, method="class")
Pred_arv<-predict(arv2, test, type="prob")

nn <- train(as.factor(amostraf$TARGET) ~ .,data=amostraf[,-201],linout = T)
